module.exports = (sequelize, DataTypes) => sequelize.define(
  'Automation',
  {
    ...
    LoginID: {
      type: DataTypes.ENUM('rpaauto', 'raja', 'funauto', 'user', 'rajawinpro64', 'raja-acer'),
    ...
    OSType: DataTypes.ENUM('AIX', 'RHEL_Linux', 'SuSe_Linux', 'Windows', 'Ubuntu_Linux'),
    SID: DataTypes.CHAR(3),
    DBTYPE: DataTypes.ENUM('ora', 'db2', 'db6', 'mss', 'hdb', 'syb', 'sdb', 'non'),
    AppType: DataTypes.ENUM('StandardABAPJava', 'APOwLC', 'BOBJ', 'CacheServer', 'ContentServer', 'ConvergentCharging', 'none'),
